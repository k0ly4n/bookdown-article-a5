...
В этом каталоге находится пример статьи, выполненной в стиле одностраничного документа формата А5.
...
2. Проконтролировать ширину таблиц - она должна быть не более 115 мм (или 100%).
